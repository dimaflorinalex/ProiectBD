...
CREATE OR REPLACE VIEW V_RECLAMATII AS
    SELECT R.ID AS ID_RECLAMATIE, R.INFORMATII, R.DATA_INREGISTRARE, R.DATA_SOLUTIONARE, R.ID_CLIENT, C.NUME, C.EMAIL, C.TELEFON, C.TIP_PERSOANA FROM RECLAMATII R
    INNER JOIN CLIENTI C ON C.ID = R.ID_CLIENT;
